...
public class LineController extends AnchorPane implements CommandPane  {
    ...
    public LineController() {
        this.toolName = "Line";
			...
			//			+ "paint" + File.separator + "plugin" + File.separator + TOOL + File.separator + "line.fxml"),this);
				uiLoader = new UILoader( getClass().getResource("line.fxml"),this);
		        uiLoader.load();
