...
public class SelectorController extends AnchorPane implements CommandPane {
	...
	public SelectorController() {
		...
		//			+ "paint" + File.separator + "plugin" + File.separator + TOOL + File.separator + "selector.fxml"), this);
			uiLoader = new UILoader( getClass().getResource("selector.fxml"),this);
	        uiLoader.load();
