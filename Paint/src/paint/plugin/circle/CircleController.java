...
public class CircleController extends AnchorPane implements CommandPane {
    ...
    public CircleController() {
        this.toolName = "Circle";
			...
			//			+ "paint" + File.separator + "plugin" + File.separator + TOOL + File.separator + "circle.fxml"),this);
				uiLoader = new UILoader( getClass().getResource("circle.fxml"),this);
		        uiLoader.load();
