...
public class TriangleController extends AnchorPane implements CommandPane {
	...
	public TriangleController() {
		...
		try {
			...
			//		+ File.separator + "paint" + File.separator + "plugin" +
			//		File.separator + TOOL + File.separator + "triangle.fxml"), this);
			uiLoader = new UILoader( getClass().getResource("triangle.fxml"),this);
	        uiLoader.load();
