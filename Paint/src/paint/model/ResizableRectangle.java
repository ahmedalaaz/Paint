...
public class ResizableRectangle {
	...
	public ResizableRectangle(double x, double y , double width , double height, Shape shape) {
	        ...
	        northEastSmallCircle.centerXProperty().bind(outerSelectorRectangle.xProperty().add(outerSelectorRectangle.widthProperty()));
	        ...
	        southWestSmallCircle.centerYProperty().bind(outerSelectorRectangle.yProperty().add(outerSelectorRectangle.heightProperty()));

	        // bottom right resize handle:
	         southEastSmallCircle = new Circle(smallCirclesRadius, smallCircleColor);
	        // bind to bottom right corner of Rectangle:
	        southEastSmallCircle.centerXProperty().bind(outerSelectorRectangle.xProperty().add(outerSelectorRectangle.widthProperty()));
	        southEastSmallCircle.centerYProperty().bind(outerSelectorRectangle.yProperty().add(outerSelectorRectangle.heightProperty()));
	        
	        // north resize handle :
	         northSmallCircle = new Circle(smallCirclesRadius , smallCircleColor);
	        // bind to top of Rectangle :
	        northSmallCircle.centerXProperty().bind(outerSelectorRectangle.xProperty().add(outerSelectorRectangle.widthProperty().divide(2)));
	        ...
	        southSmallCircle.centerXProperty().bind(outerSelectorRectangle.xProperty().add(outerSelectorRectangle.widthProperty().divide(2)));
	        southSmallCircle.centerYProperty().bind(outerSelectorRectangle.yProperty().add(outerSelectorRectangle.heightProperty()));
	        ...
	        westSmallCircle.centerYProperty().bind(outerSelectorRectangle.yProperty().add(outerSelectorRectangle.heightProperty().divide(2)));
	        
	        // east resize handle :
	         eastSmallCircle = new Circle(smallCirclesRadius , smallCircleColor);
	        // bind to east of Rectangle :
	        eastSmallCircle.centerXProperty().bind(outerSelectorRectangle.xProperty().add(outerSelectorRectangle.widthProperty()));
	        eastSmallCircle.centerYProperty().bind(outerSelectorRectangle.yProperty().add(outerSelectorRectangle.heightProperty().divide(2)));
	        // move handle:
